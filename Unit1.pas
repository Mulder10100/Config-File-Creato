...
var
  firmVer: string;
begin
  firmVer := inputbox('Firmware Version', 'Please type the version number', '');
...
begin
  Memo1.Lines.Add('connection.0.address=156.38.149.119' + slinebreak +
    ...
    'connection.2.address=156.38.149.119' + 'connection.3.address=129.232.228.4'
    + slinebreak + 'devtron.0.address=156.38.149.119' + slinebreak +
...
begin
  Memo1.Lines.Add('connection.0.address=129.232.228.4' + slinebreak +
    ...
    'connection.2.address=129.232.228.4' + 'connection.3.address=156.38.149.119'
    + slinebreak + 'devtron.0.address=129.232.228.4' + slinebreak +
...
begin
  ...
  begin
    ...
    begin
      System.AssignFile(newFile,
        'C:\Company\Software Projects\Delphi\Config Creator\Files\100000' +
        fileName + '.config');
    ...
    begin
      System.AssignFile(newFile,
        'C:\Company\Software Projects\Delphi\Config Creator\Files\10000' +
        fileName + '.config');
      System.Rewrite(newFile);
      WriteLn(newFile, thetexttoadd);
      System.CloseFile(newFile);
...
begin
  ...
  begin
    ...
    begin
      System.AssignFile(newFile,
        'C:\Company\Software Projects\Delphi\Config Creator\Files\1000000' +
        fileName + '.config');
      System.Rewrite(newFile);
      WriteLn(newFile, thetexttoadd);
      System.CloseFile(newFile);
    ...
    begin
      System.AssignFile(newFile,
        'C:\Company\Software Projects\Delphi\Config Creator\Files\1000' +
        fileName + '.config');
      System.Rewrite(newFile);
      WriteLn(newFile, thetexttoadd);
      System.CloseFile(newFile);
